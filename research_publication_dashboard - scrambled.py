...
st.markdown("""
    <div style='background-color: #FFF3CD; padding: 10px; border-radius: 5px; margin-bottom: 20px;'>
        <strong>Demo Notice:</strong> This is a demonstration of a research publications dashboard originally designed to process uploaded Excel files from METU. For this demo, the data is randomly generated and does not represent real information. This dashboard was used internally to identify and visualize relevant trends.
    </div>
